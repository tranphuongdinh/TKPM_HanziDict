        ...
        <Template title="Về chúng tớ | Hanzi Dict">
            ...
            >
                ...
                <Typography variant="p" sx={{ textAlign: "justify" }}>
                    ...
                    thuộc trong cuộc sống, biểu diễn thành chữ viết, Hán tự còn
                    là lịch sử, là văn hóa, là quan niệm của người Trung Quốc
                    thể hiện qua cách ghép các thành phần khác nhau, tạo nên một
                    chữ viết có ý nghĩa.
                </Typography>
                <br />
                <Typography variant="p" sx={{ textAlign: "justify" }}>
                    Việc học một ngôn ngữ tượng hình vốn dĩ không phải là điều
                    đơn giản. Trong quá trình học tiếng Trung, có lẽ phần khó
                    khăn nhất với hầu hết các bạn học chính là nhớ từ vựng. Nhớ
                    pinyin là dễ dàng, đánh máy bằng pinyin cũng thật dễ dàng,
                    nhưng nhớ được Hán tự, tự tay viết ra được Hán tự mới là
                    điều nan giải nhất.
                </Typography>
                <br />
                <Typography variant="p" sx={{ textAlign: "justify" }}>
                    {`Với mong muốn có thể mang đến một công cụ tiện lợi, giúp các
                    bạn đang theo học tiếng Trung có thể nhớ được Hán tự theo
                    một cách trực quan nhất, dễ hiểu nhất, chúng mình đã mang
                    đến một bộ từ điển "lạ lùng" chưa từng có. Từ điển này tập
